...
// Returns the private 'App\Repository\EpisodesRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/EpisodesRepository.php';

return $this->privates['App\\Repository\\EpisodesRepository'] = new \App\Repository\EpisodesRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
